# -*- coding: utf-8 -*-
# Generated by Django 1.9.2 on 2016-02-12 11:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goal', models.FloatField(validators=[django.core.validators.MinValueValidator(1)])),
                ('cover_image', models.ImageField(blank=True, null=True, upload_to='')),
                ('published_on', models.DateTimeField(blank=True, null=True)),
                ('status', models.IntegerField(choices=[(0, 'ACTIVE'), (1, 'SUCCESSFUL'), (2, 'NOT_FUNDED'), (3, 'CANCELED'), (4, 'DRAFT')], default=4)),
                ('currency', models.IntegerField(choices=[(0, '$'), (1, '€'), (2, 'CAD')], default=0)),
